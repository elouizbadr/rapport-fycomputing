...
\subsection{Git : Gestion des Versions Décentralisé}
...
\subsubsection{Systèmes de Contrôle des Versions Locaux}
...
\subsubsection{Systèmes de Contrôle des Versions Centralisés}
...
\subsubsection{Systèmes de Contrôle des Versions Décentralisés}
...
\subsection{CI/CD : Intégration/Déploiement Continue ?}
...
\subsection{Introduction à Jenkins}
...
\subsection{Les Dérivés Compatibles MySQL}
